      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-outfit font-bold text-brand-primary mb-6 leading-tight">
              Tecnologia, controle e adaptação{' '}
              <span className="text-brand-secondary">em uma única solução</span>
            </h2>

            <p className="text-gray-600 font-roboto mb-10 leading-relaxed max-w-xl">
            ...
            <div className="space-y-4">
              {solutionItems.map((item, i) => (
                ...
                >
                  <div className="w-10 h-10 bg-brand-highlight/10 border border-brand-highlight/10 rounded-xl flex items-center justify-center shadow-sm">
